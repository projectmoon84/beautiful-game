...
const TEAM_INPUTS: TeamInput[] = [
  ...
  { id: 'ENG', name: 'England', shortCode: 'ENG', flagEmoji: '🏴', seed: 5, titleOdds: '7/1', primaryHex: '#FFFFFF', secondaryHex: '#CE1124', tertiaryHex: '#001489', onPrimary: '#001489', onSecondary: '#FFFFFF', funFact: 'England have never won a World Cup on foreign soil.' },
