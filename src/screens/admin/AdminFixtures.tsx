...
const EVENT_TYPES: EventType[] = ['goal', 'own_goal', 'penalty', 'penalty_missed', 'var_goal', 'var_cancelled', 'yellow', 'second_yellow', 'red', 'sub', 'shootout_goal', 'shootout_miss', 'shootout_saved'];
const ICON: Record<EventType, string> = {
  ...
  shootout_goal: 'P✓', shootout_miss: 'P×', shootout_saved: 'P▣',
};
